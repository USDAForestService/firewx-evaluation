...
### Select wd based on source of files
 ...
 files = list.files("/home/wpage/Documents/ASOS/nelson_fms/obs")

 input.loc = grep("input",files)
 
 ## Start for loop for each input file
 ...
 ## Extract output
 dir = "/home/wpage/Documents/ASOS/nelson_fms/obs/"
 ...
 write.csv(dead.fms,file="deadfms_asos_obs.csv")
