...
###### in months July-Dec. This corresponds to the months on the 'Elements' drive

## Define variable Year/Month/Day and base path name
Month = c("07","08","09","10","11","12")
blabel = "/media/wpage/Elements/nomads.ncdc.noaa.gov/NDFD/"
Year = "2015"
...
Locations = read.csv("/home/wpage/Documents/raws_longs.csv")
Locations$X = NULL
...
for (j in 1:length(names)) { tryCatch({
   ...
   dir = "cd /media/wpage/Elements/nomads.ncdc.noaa.gov/NDFD/"
